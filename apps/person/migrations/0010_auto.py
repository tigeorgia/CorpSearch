...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index(u'person_person', ['name'])


    def backwards(self, orm):
        # Removing index on 'Person', fields ['name']
        db.delete_index(u'person_person', ['name'])
    ...
    models = {
        ...
        u'person.person': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'nationality': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'no_index_tag': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
