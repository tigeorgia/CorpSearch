...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'corporations_extract', 'email', self.gf('django.db.models.fields.CharField')(max_length=750, null=True))

        # Changing field 'Extract.corpurl'
        db.alter_column(u'corporations_extract', 'corpurl', self.gf('django.db.models.fields.CharField')(max_length=750, null=True))

    def backwards(self, orm):

        # Changing field 'Extract.email'
        db.alter_column(u'corporations_extract', 'email', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Extract.corpurl'
        db.alter_column(u'corporations_extract', 'corpurl', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
