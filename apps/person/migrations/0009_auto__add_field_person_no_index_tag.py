...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.no_index_tag'
        db.add_column(u'person_person', 'no_index_tag',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.no_index_tag'
        db.delete_column(u'person_person', 'no_index_tag')
