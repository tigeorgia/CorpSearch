...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Person', fields ['personal_code']
        db.create_index(u'person_person', ['personal_code'])


    def backwards(self, orm):
        # Removing index on 'Person', fields ['personal_code']
        db.delete_index(u'person_person', ['personal_code'])
