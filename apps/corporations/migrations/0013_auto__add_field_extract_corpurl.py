...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Extract.corpurl'
        db.add_column(u'corporations_extract', 'corpurl',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Extract.corpurl'
        db.delete_column(u'corporations_extract', 'corpurl')
    ...
    models = {
        ...
        u'corporations.extract': {
            ...
            'corpurl': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
