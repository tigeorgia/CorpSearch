...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LegalFormLookup'
        db.create_table(u'corporations_legalformlookup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal(u'corporations', ['LegalFormLookup'])

        # Deleting field 'Extract.legal_form'
        db.delete_column(u'corporations_extract', 'legal_form')

        # Adding field 'Extract.legalform'
        db.add_column(u'corporations_extract', 'legalform',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['corporations.LegalFormLookup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LegalFormLookup'
        db.delete_table(u'corporations_legalformlookup')

        # Adding field 'Extract.legal_form'
        db.add_column(u'corporations_extract', 'legal_form',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Extract.legalform'
        db.delete_column(u'corporations_extract', 'legalform_id')
