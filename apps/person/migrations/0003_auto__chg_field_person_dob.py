...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.dob'
        db.alter_column(u'person_person', 'dob', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Person.dob'
        db.alter_column(u'person_person', 'dob', self.gf('django.db.models.fields.DateField')(default=''))
