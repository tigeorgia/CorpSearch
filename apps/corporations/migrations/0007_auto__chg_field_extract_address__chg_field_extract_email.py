...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'corporations_extract', 'address', self.gf('django.db.models.fields.CharField')(max_length=350, null=True))

        # Changing field 'Extract.email'
        db.alter_column(u'corporations_extract', 'email', self.gf('django.db.models.fields.CharField')(max_length=350, null=True))
    ...
    models = {
        ...
        u'corporations.extract': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '350', 'null': 'True'}),
            'corp': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['corporations.Corporation']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '350', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
