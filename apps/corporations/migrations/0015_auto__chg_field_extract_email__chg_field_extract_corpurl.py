...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Extract.corpurl'
        db.alter_column(u'corporations_extract', 'corpurl', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
    ...
    models = {
        ...
        u'corporations.extract': {
            ...
            'corpurl': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
